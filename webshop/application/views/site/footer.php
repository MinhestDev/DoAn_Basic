		...
		<div class="row" id="footer">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					<address>
					  <strong>PingPongShop</strong><br>
					  <span class="glyphicon glyphicon-home" aria-hidden="true"></span> Địa chỉ: Hà Nội, Việt Nam<br>
					  <span class="glyphicon glyphicon-phone" aria-hidden="true"></span> Điện thoại: (0123) 456 789<br>
					  Copyright ©2023 - Design by PingPongShop
					</address>
				</div>
